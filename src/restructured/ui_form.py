...
from PySide6.QtWidgets import (
    QApplication, QCheckBox, QDial, QGraphicsView,
...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.pushButton.setGeometry(QRect(310, 400, 171, 71))   # E-Stop

        self.pushButton_2 = QPushButton(Widget)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(100, 340, 111, 51)) # Home
        ...
        # Raise order
        self.Actuator2.raise_()
        self.pushButton.raise_()
        self.graphicsView.raise_()
        self.scrollArea.raise_()
        self.Actuator1.raise_()
        self.Actuator3.raise_()
